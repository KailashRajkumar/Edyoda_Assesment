  ...
  return (
    <>
      <StyledForm>
        ...
        <FormContainer>
          <p>offer expired</p>
          <input id="subscription-1" type="radio" name="subscription" value="99" onChange={() => updateTotal(99)} />
        ...
        <FormContainer2>
          <p>Recommended</p>
          <input id='subscription-2' type="radio" name="subscription" value="179" onChange={() => updateTotal(179)} />
        ...
        <FormContainer3>
          <input id='subscription-3' type="radio" name="subscription" value="149" onChange={() => updateTotal(149)} />
        ...
        <FormContainer4>
          <input id='subscription-4' type="radio" name="subscription" value="99" onChange={() => updateTotal(99)} />
