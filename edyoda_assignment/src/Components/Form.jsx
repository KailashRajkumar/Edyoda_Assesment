  ...
  return (
    <>
      <StyledForm>
        <InputLabel1>
          <span>1</span>
          <input type="button" name='signin' id='sign-in' value={"Sign in"} />
        </InputLabel1>
        <InputLabel2>
          <span>2</span>
        ...
        <FormContainer>
          <p>offer expired</p>
          <input id="subscription-1" type="radio" name="subscription1" value="99" onChange={() => updateTotal(99)} />
        ...
        <FormContainer2>
          <p>Recommended</p>
          <input id='subscription-2' type="radio" name="subscription2" value="179" onChange={() => updateTotal(179)} />
        ...
        <FormContainer3>
          <input id='subscription-3' type="radio" name="subscription3" value="149" onChange={() => updateTotal(149)} />
        ...
        <FormContainer4>
          <input id='subscription-4' type="radio" name="subscription4" value="99" onChange={() => updateTotal(99)} />
